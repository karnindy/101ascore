...
<html lang="en">
    ...
    <body>
        ...
        <div id="report_area" style="display:none">
            ...
            <p class="text-center font-weight-bold">รายงานการติดตามผลการพิจารณาบัตรเครดิตและสินเชื่อบัตรเงินสด ณ ช่วงเวลาที่แตกต่างกัน</p>
            <p class="text-center font-weight-bold">Approval Rate Report(REP02)</p>
            <div class="row mb-5">
                <div class="col-md-12">

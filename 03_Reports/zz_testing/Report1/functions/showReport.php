...
while ($row = oci_fetch_array($query,OCI_BOTH)) {
    if(strtolower($row['SCORE_RANGE_DESC']) == "total"){
        $table = $table."<tr style='background-color:#feccff;font-weight: 700;'>
                            ...
                            <td class='text-right'>" . $row['DEV'] . "</td>
                            <td class='text-right'>" . $row['PER_DEV'] . "</td>
                            <td class='text-right'>" . $row['ACTUAL'] . "</td>
                            <td class='text-right'>" . $row['PER_ACTUAL'] . "</td>
                            ...
                            <td class='text-right'>" . $row['PER_APPROVE'] . "</td>
                            <td class='text-right'>" . $row['PER_REJECT'] . "</td>
                        </tr>";
    } else {
        $table = $table."<tr>
                            <td>" . $row['SCORE_RANGE_DESC'] . "</td>

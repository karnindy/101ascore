...
while ($row = oci_fetch_array($query,OCI_BOTH)) {
    $table = $table."<tr>
                    <td>" . $row['CATEGORY'] . "</td>
                    <td class='text-right'>" . $row['TOTAL_ACTUAL_3M'] . "</td>
                    <td class='text-right'>" . $row['OPER_OVERRIDE_3M'] . "</td>
                    <td class='text-right'>" . $row['TOTAL_ACTUAL_6M'] . "</td>
                    <td class='text-right'>" . $row['PER_OVERRIDE_6M'] . "</td>
                    <td class='text-right'>" . $row['TOTAL_ACTUAL_12M'] . "</td>
                    <td class='text-right'>" . $row['PER_OVERRIDE_12M'] . "</td>
                </tr>";

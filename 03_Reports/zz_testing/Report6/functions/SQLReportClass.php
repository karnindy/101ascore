...
function get_report_sql($product_type, $model_type, $card_type, $region_name, $zone_name, $branch_name, $model_version, $sales_channel, $month, $year, $business_type) {
       ...
       ,aa.total_actual_3m
       ,'('||aa.total_actual_3m||'/'||case when bb.total_actual_3m = 0 then 1 else bb.total_actual_3m end||')*100' oper_override_3m
       ,aa.total_actual_6m
       ,'('||aa.total_actual_6m||'/'||case when bb.total_actual_6m = 0 then 1 else bb.total_actual_6m end||')*100' per_override_6m
       ,aa.total_actual_12m
       ,'('||aa.total_actual_12m||'/'||case when bb.total_actual_12m = 0 then 1 else bb.total_actual_12m end||')*100' per_override_12m
       from

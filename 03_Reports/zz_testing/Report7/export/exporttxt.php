...
fwrite($file, "| | |Currentt Validation Sample(%)| | |Development Sample(%)| |Past 12 Months| | \r\n");
fwrite($file, "|Score Range|% Cum_G|% Cum_B|Sep_BG|% BadRate(Current)|% Cum_G|% Cum_B|Sep_BG|% BadRate(Current)| \r\n");

...
fwrite($objWrite, "\"\",\"\",\"Currentt Validation Sample(%)\",\"\",\"\",\"Development Sample(%)\",\"\",\"Past 12 Months\",\"\" \n");
fwrite($objWrite, "\"Score Range\",\"% Cum_G\",\"% Cum_B\",\"Sep_BG\",\"% BadRate(Current)\",\"% Cum_G\",\"% Cum_B\",\"Sep_BG\",\"% BadRate(Current)\" \n");

    ...
    <body>
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-6 form-group row">
                ...
                <div class="col-md-8">
                    <select class="form-control" name="card_type" id="card_type" onchange="getValueDropdown(this)" target="factors">
                        <option disabled selected>--โปรดเลือก--</option>
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-8 form-group row">
                <label class="col-md-3 col-form-label text-right font-weight-bold" for="factors">* ปัจจัย : </label>
                <div class="col-md-6">
                    <select class="form-control" name="factors" id="factors">
                        <option disabled selected>--โปรดเลือก--</option>
                    </select>
                </div>
            </div>
        ...
        <div id="report_area" style="display:none">
            ...
            <p class="text-center font-weight-bold">รายงานการเปรียบเทียบการเปลี่ยนแปลงคุณลักษณะของลูกค้าปัจจุบันกับลูกค้าช่วงที่ใช้พัฒนาแบบจำลองฯ</p>
            <p class="text-center font-weight-bold">Characteristic Analysis Rate Report(REP03)</p>
            <div class="row mb-5">
                <div class="col-md-12">
                    <span class="font-weight-bold">ปัจจัย :</span> <span id="factors_show"></span>
                </div>
                <div class="col-md-12">

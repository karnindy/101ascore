...
// $pdf->Cell(0,5,iconv('UTF-8','cp874','ธนาคารออมสิน'),0,1,'C');
$pdf->cell(56,10,iconv('UTF-8','cp874',$s1),1,0,'C',true);
$pdf->cell(32,10,iconv('UTF-8','cp874',$s2),1,0,'C',true);
$pdf->cell(32,10,iconv('UTF-8','cp874',$s3),1,0,'C',true);
$pdf->cell(32,10,iconv('UTF-8','cp874',$s4),1,0,'C',true);
$pdf->cell(32,10,iconv('UTF-8','cp874',$s5),1,0,'C',true);
$pdf->cell(32,10,iconv('UTF-8','cp874',$s6),1,0,'C',true);
$pdf->cell(32,10,iconv('UTF-8','cp874',$s7),1,0,'C',true);
$pdf->cell(32,10,iconv('UTF-8','cp874',$s8),1,1,'C',true);
...
$pdf->cell(56,10,iconv('UTF-8','cp874',$s1),1,0,'C');
$pdf->cell(32,10,iconv('UTF-8','cp874',$s2),1,0,'C');
$pdf->cell(32,10,iconv('UTF-8','cp874',$s3),1,0,'C');
$pdf->cell(32,10,iconv('UTF-8','cp874',$s4),1,0,'C');
$pdf->cell(32,10,iconv('UTF-8','cp874',$s5),1,0,'C');
$pdf->cell(32,10,iconv('UTF-8','cp874',$s6),1,0,'C');
$pdf->cell(32,10,iconv('UTF-8','cp874',$s7),1,0,'C');
$pdf->cell(32,10,iconv('UTF-8','cp874',$s8),1,1,'C');
}
}

...
while ($row = oci_fetch_array($query,OCI_BOTH)) {
    if(preg_match("/Total/i", $row['SCORE_RANGE_DESC'])){
        $table = $table."<tr style='background-color:#feccff;'>
                    ...
                    <td class='text-right'>" . $row['BAD1_30PAST3MONTHS'] . "</td>
                    <td class='text-right'>" . $row['BAD1_30PAST12MONTHS'] . "</td>
                    <td class='text-right'>" . $row['BAD1_30PASTMORE12'] . "</td>
                    <td class='text-right'>" . $row['BAD31_60PAST3MONTHS'] . "</td>
                    <td class='text-right'>" . $row['BAD31_60PAST12MONTHS'] . "</td>
                    <td class='text-right'>" . $row['BAD31_60PASTMORE12'] . "</td>
                    <td class='text-right'>" . $row['BAD61_90PAST3MONTHS'] . "</td>
                    <td class='text-right'>" . $row['BAD61_90PAST12MONTHS'] . "</td>
                    <td class='text-right'>" . $row['BAD61_90PASTMORE12'] . "</td>
                </tr>";

...
,round((sum(a.approve)/case when nvl(max(b.total_approve),0) = 0 then 1 else nvl(max(b.total_approve),0) end)*100,2) per_accept_acct
,round((sum(a.active)/case when sum(a.approve) = 0 then 1 else sum(a.approve) end)*100,2) per_active_acct
,round((sum(a.ever1_30)/case when sum(a.approve) = 0 then 1 else sum(a.approve) end)*100,2) per_current_1_30
,round((sum(a.ever31_60)/case when sum(a.approve) = 0 then 1 else sum(a.approve) end)*100,2) per_current_31_60
,round((sum(a.ever61_90)/case when sum(a.approve) = 0 then 1 else sum(a.approve) end)*100,2) per_current_61_90
,round((sum(a.delmore_90)/case when sum(a.approve) = 0 then 1 else sum(a.approve) end)*100,2) per_current_more_90

...
while ($row = oci_fetch_array($query,OCI_BOTH)) {
    if(strtolower($row['SCORE_RANGE_DESC']) == "total"){
        $table = $table."<tr style='background-color:#feccff;font-weight: 700;'>
                            ...
                            <td class='text-right'>" . $row['PER_ACCEPT_ACCT'] . "</td>
                            <td class='text-right'>" . $row['PER_ACTIVE_ACCT'] . "</td>
                            <td class='text-right'>" . $row['PER_CURRENT_1_30'] . "</td>
                            <td class='text-right'>" . $row['PER_CURRENT_31_60'] . "</td>
                            <td class='text-right'>" . $row['PER_CURRENT_61_90'] . "</td>
                            <td class='text-right'>" . $row['PER_CURRENT_MORE_90'] . "</td>
                        </tr>";
    } else {
        $table = $table."<tr>
                            <td>" . $row['SCORE_RANGE_DESC'] . "</td>

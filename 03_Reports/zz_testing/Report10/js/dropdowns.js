...
function test(e){
    console.log(e.value.split("-").reverse())
}
...
function onSubmit() {
    ...
    const start_mm = start_date_temp.split("-")[1]
    const start_yyyy = start_date_temp.split("-")[0]
    const end_mm = end_date_temp.split("-")[1]
    const end_yyyy = end_date_temp.split("-")[0]
    ...
    document.getElementById("start_date_show").innerHTML = `${start_mm}/${start_yyyy}`;
    document.getElementById("end_date_type_show").innerHTML = `${end_mm}/${end_yyyy}`;

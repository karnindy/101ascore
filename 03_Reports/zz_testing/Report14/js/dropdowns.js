...
function onSubmit() {
    ...
    if(product_type === '--โปรดเลือก--' || model_type === '--โปรดเลือก--' || card_type === '--โปรดเลือก--' || model_version === '--โปรดเลือก--' || !start_date_temp || !end_date_temp || report_id === '--โปรดเลือก--' || !compareDate(start_date_temp,end_date_temp)) {
    ...
    document.getElementById('report_name').innerHTML = report_id;

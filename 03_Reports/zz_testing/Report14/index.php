...
<body onclick="check_date_between()">
    <style>
    ...
    <div class="container">
        <div class="row mt-5">
            ...
            <div class="col-md-8 form-group row p-0">
                ...
                <div class="col-md-4">
                    <input class="form-control datepicker-month" type="text" name="start_date" id="start_date" placeholder="MM/YYYY">
                </div>
                <div class="col-md-1">ถึง</div>
                <div class="col-md-4">
                    <input class="form-control datepicker-month" type="text" name="end_date" id="end_date" placeholder="MM/YYYY">
                </div>
                <div class="col-md-3 text-right text-danger font-weight-bold d-none" id="check_date">* เลือกวันที่ไม่ถูกต้อง</div>
            </div>
            <div class="col-md-6 form-group row">
                <label class="col-md-4 col-form-label text-right font-weight-bold" for="report_id">* ชนิดรายงาน</label>
                <div class="col-md-8">
                    <select class="form-control" name="report_id" id="report_id">
                        <option selected disabled>--โปรดเลือก--</option>
                        <option value='รายงานติดตามประเมินผลการใช้คะแนนเครดิต(Credit Bureau Score) ประกอบการพิจารณาอนุมัติบัตรเครดิตและสินเชื่อบัตรเงินสด'>รายงานติดตามประเมินผลการใช้คะแนนเครดิต(Credit Bureau Score) ประกอบการพิจารณาอนุมัติบัตรเครดิตและสินเชื่อบัตรเงินสด</option>
                        <option value='รายงานแสดงร้อยละของลูกค้าบัตรเครดิตสินเชื่อบัตรเงินสด แยกตามระดับความเสี่ยงและสถานะของลูกค้า'>รายงานแสดงร้อยละของลูกค้าบัตรเครดิตสินเชื่อบัตรเงินสด แยกตามระดับความเสี่ยงและสถานะของลูกค้า</option>
                        <option value='รายงานติดตามการชำระหนี้สำหรับลูกค้าบัตรเครดิต/สินเชื่อบัตรเงินสด แยกตามระดับความเสี่ยง(เกรด)'>รายงานติดตามการชำระหนี้สำหรับลูกค้าบัตรเครดิต/สินเชื่อบัตรเงินสด แยกตามระดับความเสี่ยง(เกรด)</option>
                    </select>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div id="report_area" style="display:none">
            ...
            <p class="text-center font-weight-bold">รายงานการวิเคราะห์และติดตามประเมินผลการใช้แบบจำลองฯ วัดระดับความเสี่ยง</p>
            <!-- <br> -->
            <p class="text-center font-weight-bold">Credit Scoring Model(REP14)</p>
            <p class="text-center font-weight-bold">ชนิด: <span id="report_name"></span></p>
            <div class="row mb-5">
                <div class="col-md-12">

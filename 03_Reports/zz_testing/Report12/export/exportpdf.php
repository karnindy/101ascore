...
$pdf->Cell(0,4,iconv('UTF-8','cp874','รายงานความสามารถในการชำระหนี้ของลูกค้าในแต่ละช่วงเกรด อัตราการเกิดหนี้เสียหลังจากที่นำระบบ Credit Scoring เข้ามาใช้งาน'),0,1,'C');
$pdf->Ln();
$pdf->SetFont('THSarabunNew','B',18);
$pdf->Cell(0,4,iconv('UTF-8','cp874','Portfolio Grade Performance Report ( REP12 )'),0,1,'C');
$pdf->Ln(6);
...
$pdf->cell(38,20,'Grade Range',1,0,'C',true);
$pdf->cell(60,10,'Active account',1,0,'C',true);
$pdf->Cell(180,10,iconv('UTF-8','cp874','หนี้ที่ไม่ก่อรายได้ (NPLs)'),1,1,'C',true);
...
$pdf->cell(33.75,10,'%Amount',1,0,'C',true);
$pdf->cell(45,10,'% of Cumulative NPLs',1,0,'C',true);
$pdf->Ln();

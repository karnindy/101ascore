...
<body onclick="check_date_between()">
    ...
    <div class="container">
        ...
        <div id="report_area" style="display:none">
            ...
            <p class="text-center font-weight-bold">รายงานความสามารถในการชำระหนี้ของลูกค้าในแต่ละช่วงเกรด อัตราการเกิดหนี้เสียหลังจากที่นำระบบ Credit Scoring เข้ามาใช้งาน</p>
            <!-- <br> -->
            <p class="text-center font-weight-bold">Portfolio Grade Performance Report(REP12)</p>
            <div class="row mb-5">
                <div class="col-md-12">

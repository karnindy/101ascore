...
<body onclick="check_date_between()">
    ...
    <div class="container">
        ...
        <div id="report_area" style="display:none">
            ...
            <p class="text-center font-weight-bold">รายงานความสามารถในการชำระหนี้ของลูกค้าในแต่ละช่วงคะแนน อัตราการเกิดหนี้เสียหลังจากที่นำระบบ Credit Scoring เข้ามาใช้งาน</p>
            <!-- <br> -->
            <p class="text-center font-weight-bold">Portfolio Score Performance Report(REP11)</p>
            <div class="row mb-5">
                <div class="col-md-12">

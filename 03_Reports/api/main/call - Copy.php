...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'ascoreprdsm:8092/DAServiceREST');
...
for($i = 0 ; $i < count($out_xml->Out->AscoreInput->item) ; $i++) {
  ...
  $sql_command = "INSERT INTO ASCOREDW.APS_ONLINE_WS (".implode($insert_cols, ",").") VALUES(".implode($insert_values, ",").")";

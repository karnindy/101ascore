...
,sum(nvl(bbb.actual,0)) / case when sum(nvl(bbb.total_actual,0)) = 0 then 1 else  sum(nvl(bbb.total_actual,0)) end * 100
- max(nvl(ccc.dev,0)) / case when max(nvl(ccc.total_dev,0)) = 0 then 1 else  max(nvl(ccc.total_dev,0)) end * 100 per_change


,case when (max(nvl(ccc.dev,0)) / case when max(nvl(ccc.total_dev,0)) = 0 then 1 else  max(nvl(ccc.total_dev,0)) end * 100) = 0 then 1 else (sum(nvl(bbb.actual,0)) / case when sum(nvl(bbb.total_actual,0)) = 0 then 1 else  sum(nvl(bbb.total_actual,0)) end * 100)
/ (max(nvl(ccc.dev,0)) / case when max(nvl(ccc.total_dev,0)) = 0 then 1 else  max(nvl(ccc.total_dev,0)) end * 100) end ratio

,ln(case when (case when (max(nvl(ccc.dev,0)) / case when max(nvl(ccc.total_dev,0)) = 0 then 1 else  max(nvl(ccc.total_dev,0)) end * 100) = 0 then 1 else (sum(nvl(bbb.actual,0)) / case when sum(nvl(bbb.total_actual,0)) = 0 then 1 else  sum(nvl(bbb.total_actual,0)) end * 100)
/ (max(nvl(ccc.dev,0)) / case when max(nvl(ccc.total_dev,0)) = 0 then 1 else  max(nvl(ccc.total_dev,0)) end * 100) end) = 0 then 1
else (case when (max(nvl(ccc.dev,0)) / case when max(nvl(ccc.total_dev,0)) = 0 then 1 else  max(nvl(ccc.total_dev,0)) end * 100) = 0 then 1 else (sum(nvl(bbb.actual,0)) / case when sum(nvl(bbb.total_actual,0)) = 0 then 1 else  sum(nvl(bbb.total_actual,0)) end * 100)
/ (max(nvl(ccc.dev,0)) / case when max(nvl(ccc.total_dev,0)) = 0 then 1 else  max(nvl(ccc.total_dev,0)) end * 100) end) end) woe

,((sum(nvl(bbb.actual,0)) / case when sum(nvl(bbb.total_actual,0)) = 0 then 1 else  sum(nvl(bbb.total_actual,0)) end * 100
- round(max(nvl(ccc.dev,0)) / case when max(nvl(ccc.total_dev,0)) = 0 then 1 else  max(nvl(ccc.total_dev,0)) end * 100,2))/100) * (ln(case when (case when (max(nvl(ccc.dev,0)) / case when max(nvl(ccc.total_dev,0)) = 0 then 1 else  max(nvl(ccc.total_dev,0)) end * 100) = 0 then 1 else (sum(nvl(bbb.actual,0)) / case when sum(nvl(bbb.total_actual,0)) = 0 then 1 else  sum(nvl(bbb.total_actual,0)) end * 100)
/ (max(nvl(ccc.dev,0)) / case when max(nvl(ccc.total_dev,0)) = 0 then 1 else  max(nvl(ccc.total_dev,0)) end * 100) end) = 0 then 1
else (case when (max(nvl(ccc.dev,0)) / case when max(nvl(ccc.total_dev,0)) = 0 then 1 else  max(nvl(ccc.total_dev,0)) end * 100) = 0 then 1 else (sum(nvl(bbb.actual,0)) / case when sum(nvl(bbb.total_actual,0)) = 0 then 1 else  sum(nvl(bbb.total_actual,0)) end * 100)
/ (max(nvl(ccc.dev,0)) / case when max(nvl(ccc.total_dev,0)) = 0 then 1 else  max(nvl(ccc.total_dev,0)) end * 100) end) end)) index_

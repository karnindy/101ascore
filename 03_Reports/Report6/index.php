...
<html lang="en">
    ...
    <body>
        ...
        <div id="report_area" style="display:none">
            ...
            <p class="text-center font-weight-bold">รายงานแสดงสัดส่วนเหตุผลการ Override ของลูกค้า</p>
            <p class="text-center font-weight-bold">Override Reason Report(REP06)</p>
            <div class="row mb-5">
                <div class="col-md-12">

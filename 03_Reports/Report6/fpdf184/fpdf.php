...
function Header()
{
	...
	$this->cell(75,20,'Category ',1,0,'C',true);
	$this->cell(67,10,'Past 3 Months',1,0,'C',true);
	$this->cell(67,10,'Past 6 Months',1,0,'C',true);
	$this->cell(67,10,'Past 12 Months',1,1,'C',true);
	$this->cell(75,10,'',0,0,'L');
	$this->SetFont('THSarabunNew','B',14);
	$this->cell(32,10,'Number of Loans',1,0,'C',true);
	$this->cell(35,10,'% of Total Overrides',1,0,'C',true);
	$this->cell(32,10,'Number of Loans',1,0,'C',true);
	$this->cell(35,10,'% of Total Overrides',1,0,'C',true);
	$this->cell(32,10,'Number of Loans',1,0,'C',true);
	$this->cell(35,10,'% of Total Overrides',1,1,'C',true);
	}
}

...
,case when sum(nvl(below_cutoff_approve,0))>sum(approve_rpt1) then sum(approve_rpt1) else sum(nvl(below_cutoff_approve,0)) end *100/case when sum(approve_rpt1+reject_rpt1) = 0 then 1 else sum(approve_rpt1+reject_rpt1) end app_in_range_3m
from prepare_source_st4
where product_type = '#product_type#'
and model_name = '#model_name#'
and ('#card_type#' = 'รวมทุกประเภทบัตร' or card_type = '#card_type#')
...
,case when sum(nvl(pass_cutoff_reject,0)) < sum(reject_rpt1) then sum(reject_rpt1) else sum(nvl(pass_cutoff_reject,0)) end *100/case when sum(approve_rpt1+reject_rpt1) = 0 then 1 else sum(approve_rpt1+reject_rpt1) end app_in_range_3m
from prepare_source_st4
where product_type = '#product_type#'
and model_name = '#model_name#'
and ('#card_type#' = 'รวมทุกประเภทบัตร' or card_type = '#card_type#')
...
union all
select '% Approved' category
,case when sum(nvl(below_cutoff_approve,0))>sum(approve_rpt1) then sum(approve_rpt1) else sum(nvl(below_cutoff_approve,0)) end*100/case when sum(approve_rpt1+reject_rpt1) = 0 then 1 else sum(approve_rpt1+reject_rpt1) end app_in_range_12m
from prepare_source_st4
where product_type = '#product_type#'
and model_name = '#model_name#'
and ('#card_type#' = 'รวมทุกประเภทบัตร' or card_type = '#card_type#')
...
union all
select '% Declined' category
,case when sum(nvl(pass_cutoff_reject,0)) < sum(reject_rpt1) then sum(reject_rpt1) else sum(nvl(pass_cutoff_reject,0)) end*100/case when sum(approve_rpt1+reject_rpt1) = 0 then 1 else sum(approve_rpt1+reject_rpt1) end app_in_range_12m
from prepare_source_st4
where product_type = '#product_type#'
and model_name = '#model_name#'
and ('#card_type#' = 'รวมทุกประเภทบัตร' or card_type = '#card_type#')
...
union all
select '% Approved' category
,case when sum(nvl(below_cutoff_approve,0))>sum(approve_rpt1) then sum(approve_rpt1) else sum(nvl(below_cutoff_approve,0)) end*100/case when sum(approve_rpt1+reject_rpt1) = 0 then 1 else sum(approve_rpt1+reject_rpt1) end app_in_range_more12m
from prepare_source_st4
where product_type = '#product_type#'
and model_name = '#model_name#'
and ('#card_type#' = 'รวมทุกประเภทบัตร' or card_type = '#card_type#')
...
union all
select '% Declined' category
,case when sum(nvl(pass_cutoff_reject,0)) < sum(reject_rpt1) then sum(reject_rpt1) else sum(nvl(pass_cutoff_reject,0)) end*100/case when sum(approve_rpt1+reject_rpt1) = 0 then 1 else sum(approve_rpt1+reject_rpt1) end app_in_range_more12m
from prepare_source_st4
where product_type = '#product_type#'
and model_name = '#model_name#'
and ('#card_type#' = 'รวมทุกประเภทบัตร' or card_type = '#card_type#')
...
union all
select '% Approved' category
,case when sum(nvl(below_cutoff_approve,0)) >= sum(approve_rpt1) then sum(approve_rpt1) else sum(nvl(below_cutoff_approve,0)) end *100/case when sum(approve_rpt1) = 0 then 1 else sum(approve_rpt1) end approval_3m
from prepare_source_st4
where product_type = '#product_type#'
and model_name = '#model_name#'
and ('#card_type#' = 'รวมทุกประเภทบัตร' or card_type = '#card_type#')
...
union all
select '% Approved' category
,case when sum(nvl(below_cutoff_approve,0)) >= sum(approve_rpt1) then sum(approve_rpt1) else sum(nvl(below_cutoff_approve,0)) end *100/case when sum(approve_rpt1) = 0 then 1 else sum(approve_rpt1) end approval_12m
from prepare_source_st4
where product_type = '#product_type#'
and model_name = '#model_name#'
and ('#card_type#' = 'รวมทุกประเภทบัตร' or card_type = '#card_type#')
...
union all
select '% Approved' category
,case when sum(nvl(below_cutoff_approve,0)) >= sum(approve_rpt1) then sum(approve_rpt1) else sum(nvl(below_cutoff_approve,0)) end *100/case when sum(approve_rpt1) = 0 then 1 else sum(approve_rpt1) end approval_more12m
from prepare_source_st4
where product_type = '#product_type#'
and model_name = '#model_name#'
and ('#card_type#' = 'รวมทุกประเภทบัตร' or card_type = '#card_type#')

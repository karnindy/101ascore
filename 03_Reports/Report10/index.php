...
<body>
    ...
    <div class="row mt-5">
            ...
            <div class="col-md-8 form-group row p-0">
                ...
                <div class="col-md-4">
                    <input class="form-control" type="month" name="start_date" id="start_date" onchange="check_date_between()">
                </div>
                <div class="col-md-1">ถึง</div>
                <div class="col-md-4">
                    <input class="form-control" type="month" name="end_date" id="end_date" onchange="check_date_between()">
                </div>
        ...
        <div id="report_area" style="display:none">
            ...
            <p class="text-center font-weight-bold">รายงานอัตราการผิดนัดชำระหนี้ของลูกค้าตามระดับคะแนน ณ ช่วงไตรมาสต่างกันในแต่ละช่วงคะแนน</p>
            <!-- <br> -->
            <p class="text-center font-weight-bold">Delinquency Distribution Report(REP10)</p>
            <div class="row mb-5">
                <div class="col-md-12">

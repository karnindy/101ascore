...
,round((sum(a.ever1_30)/case when sum(a.active) = 0 then 1 else sum(a.active) end)*100,2) per_current_1_30
,round((sum(a.ever31_60)/case when sum(a.active) = 0 then 1 else sum(a.active) end)*100,2) per_current_31_60
,round((sum(a.ever61_90)/case when sum(a.active) = 0 then 1 else sum(a.active) end)*100,2) per_current_61_90
,round((sum(a.delmore_90)/case when sum(a.active) = 0 then 1 else sum(a.active) end)*100,2) per_current_more_90

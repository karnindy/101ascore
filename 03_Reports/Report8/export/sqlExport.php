...
and create_date between last_day(add_months(to_date('01/'||'#MM#'||'#YYYY#','dd/mm/yyyy'),-4))+1
and last_day(add_months(to_date('01/'||'#MM#'||'#YYYY#','dd/mm/yyyy'),-1))
...
and ('#zone_name#' = 'รวมทุกเขต' or zone_name in ('#zone_name#'))
and ('#branch_name#' = 'รวมทุกสาขา' or branch_name in ('#branch_name#'))
and create_date between last_day(add_months(to_date('01/'||'#MM#'||'#YYYY#','dd/mm/yyyy'),-13))+1
and last_day(add_months(to_date('01/'||'#MM#'||'#YYYY#','dd/mm/yyyy'),-1))
group by a.score_range_desc
,a.product_type
,'#model_name#'

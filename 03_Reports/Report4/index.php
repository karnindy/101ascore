...
<body>
    ...
    <div class="row mt-5">
        ...
        <div id="report_area" style="display:none">
            ...
            <!-- <p class="text-center font-weight-bold">รายงานแสดงสัดส่วนของลูกค้าที่มีการ Override ทั้ง High-Side Override และ Low-Side Override</p> -->
            <p class="text-center font-weight-bold">Final Score Report(REP04)</p>
            <div class="row mb-5">
                <div class="col-md-12">
